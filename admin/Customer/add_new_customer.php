...
<div class="col-sm-6 col-md-4 col-lg-4">
    <div class="form-group">
        ...
        <label class="label-brdr" style="width: 0%;"></label>
                ...
                <!-- <div class="col-sm-6 col-md-4 col-lg-4" id="o_name">
                  <div class="form-group">
                    <label>Organization Name</label>
                    <input class="form-control" required name="o_name" placeholder="" type="text" value="<?php echo $res['o_name']; ?>" onFocus="txtFocus(this);" onfocusout="txtFocusOut(this);">
                    <label class="label-brdr" style="width: 0%;"></label>
                  </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-4" id="gst">
                  <div class="form-group">
                    <label>GST Number</label>
                    <input class="form-control" required name="gst" placeholder="" type="text" value="<?php echo $res['gst']; ?>" onFocus="txtFocus(this);" onfocusout="txtFocusOut(this);">
                    <label class="label-brdr" style="width: 0%;"></label>
                  </div>
                </div> -->
                <div class="col-sm-12 col-md-12 col-lg-12">
