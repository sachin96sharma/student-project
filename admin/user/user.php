            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-md-4 col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control"  name="password" id="password" placeholder="" minlength=10 value="<?php if(!$res['user_pass']==""){ echo decryptIt($res['user_pass']); }?>" type="password" onFocus="txtFocus(this);" onfocusout="txtFocusOut(this);">
                  <label class="label-brdr" style="width: 0%;"></label>
                </div>
              </div>
              <div class="col-sm-4 col-md-4 col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control"  name="confirm_password" id="confirm_password" minlength=10 placeholder="" value="<?php if(!$res['user_pass']==""){ echo decryptIt($res['user_pass']); }?>" type="password" onFocus="txtFocus(this);" onfocusout="txtFocusOut(this);">
                  <label class="label-brdr" style="width: 0%;"></label>
                </div>
              </div>
              <div class="col-sm-4 col-md-4 col-lg-4">
