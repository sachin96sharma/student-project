...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_SERVER['CONTENT_TYPE']) && $_SERVER['CONTENT_TYPE'] === 'application/json') {
    ...
    if (!isset($jsonData['game_id'], $jsonData['user_id'], $jsonData['bet_amount'], $jsonData['gamebiding'])) {
    ...
    $gamebiding = mysqli_real_escape_string($link, $jsonData['gamebiding']);

    // Prepare the SQL query
    $sql = "INSERT INTO reports (game_id, user_id, bet_amount, gamebiding) VALUES ('$game_id', '$user_id', '$bet_amount', '$gamebiding')";
